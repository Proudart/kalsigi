...
function ChapterSkeleton() {
  return (
    <div className="animate-pulse bg-background-50 ">
      <header className="sticky top-0 z-30 bg-background-100/90  backdrop-blur-md border-b border-background-300 ">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="h-6 w-32 bg-background-200 rounded-md"></div>
          <div className="flex space-x-2">
            <div className="h-8 w-8 bg-background-200  rounded-full"></div>
            <div className="h-8 w-16 bg-background-200  rounded-md"></div>
            <div className="h-8 w-8 bg-background-200  rounded-full"></div>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-6xl mx-auto px-4 pt-8 pb-6">
        <div className="h-4 w-full max-w-md bg-background-200  rounded-md mb-6"></div>
        <div className="h-10 w-3/4 bg-background-200  rounded-md mb-6"></div>
      ...
      <div className="max-w-3xl mx-auto px-4 mb-6">
        <div className="h-12 w-full bg-background-200  rounded-md"></div>
      </div>
      
      <div className="max-w-3xl mx-auto px-4 mb-8">
        <div className="h-96 bg-background-200  rounded-md mb-4"></div>
        <div className="h-96 bg-background-200  rounded-md mb-4"></div>
        <div className="h-96 bg-background-200  rounded-md"></div>
      </div>
    </div>
  );
}