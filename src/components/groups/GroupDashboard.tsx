...
import { Users, Settings, Upload, BarChart3, UserPlus, BookOpen } from 'lucide-react';
...
export default function GroupDashboard() {
  ...
  const canManageSeries = ['owner', 'co-owner', 'moderator'].includes(group?.userRole || '');
  ...
  return (
        ...
        <Card className="border-yellow-200 bg-yellow-50">
          <CardContent className="pt-6">
            <p className="text-yellow-800">
              <strong>Pending Approval:</strong> Your group is waiting for admin approval.
              You can manage settings and invite members, but content upload will be available after approval.
            </p>
          </CardContent>
        </Card>
      )}
        ...
        <TabsContent value="series">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-muted-foreground">Manage your groups series here.</p>
              <Link href={`/groups/${group.slug}/series`}>
                <Button>
                <BookOpen className="w-4 h-4 mr-2" />
                View All Series
    ...
    </TabsContent><TabsContent value="content">
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <p className="text-muted-foreground">Content upload feature coming soon...</p>
          </CardContent>
        </Card>
      </TabsContent>
