        ...
        <TabsContent value="guidelines" className="mt-6">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                <h3 className="font-semibold text-lg mb-3">Cover Image Guidelines</h3>
                <ul className="space-y-2 text-sm text-text-700">
                  <li className="flex items-start space-x-2">
                    <span className="text-primary-600 font-bold">•</span>
                  ...
                  <li className="flex items-start space-x-2">
                    <span className="text-primary-600 font-bold">•</span>
                    <span>Should be appropriate and represent the series well</span>
                  </li>
                </ul>
              </div>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <ul className="space-y-2 text-sm text-green-800">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Your group name will be displayed as Originally submitted by [Group Name]</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-green-600 font-bold">✓</span>
                      <span>Credit appears on the series page and in search results</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-green-600 font-bold">✓</span>
                      <span>Your group gains recognition in the community</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-green-600 font-bold">✓</span>
              ...
              <div>
                <h3 className="font-semibold text-lg mb-3">Common Rejection Reasons</h3>
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  <ul className="space-y-2 text-sm text-red-800">
                    <li className="flex items-start space-x-2">
                      <span className="text-red-600 font-bold">✗</span>
                      <span>Series already exists in the database</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-red-600 font-bold">✗</span>
                    ...
                    <li className="flex items-start space-x-2">
                      <span className="text-red-600 font-bold">✗</span>
                      <span>Series doesnt meet platform guidelines</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-red-600 font-bold">✗</span>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p className="text-sm text-blue-700">
                  ...
                  feel free to contact our support team or check our FAQ section.
                </p>
              </div>
            </CardContent>
          </Card>
